...
public class ProjectEulerSolver {
    ...
    public static int  ProjectEuler8() {
        String string = """
    ...
    public static String ProjectEuler13(){
        ...
        String[] numberList = string.split("\n");
        double sum = 0;
        for (int i = 0; i < numberList.length; i++) {
            sum += Double.valueOf(numberList[i]);
        }
        String result = String.format("%.0f", sum).substring(0, 10);
        return result;
    }
